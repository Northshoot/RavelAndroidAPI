...
public class RavelPermissions {
    public static final int PERMISSION_REQUEST_BLE_ADMIN = 0;
    ...
    public static final int PERMISSION_REQUEST_WAKE_LOCK = 4;
    public static final int PERMISSION_REQUEST_READ_PHONE_STATE = 5;
    public static final int PERMISSION_REQUEST_RECEIVE_BOOT_COMPLETED =6;
}
